...
- Support for `-` in `apiary_managed_schemas` variable. `-` will be replaced with `_` for Hive DB names. Fixes [#5] (https://github.com/ExpediaInc/apiary/issues/5). Requires version greater than `v1.0.0` of https://github.com/ExpediaInc/apiary-metastore-docker
