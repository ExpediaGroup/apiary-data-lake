...
## [6.4.0] - [TBD]
### Added
- Create`apiary_system` database and buckets. This is pre-fork for Ranger access logs Hive tables and other system data. Requires `apiary-metastore-docker` version `1.15.0` or above.
