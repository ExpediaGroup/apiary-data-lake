...
| tags | Additional tags added to the S3 data bucket. If the var.apiary_tags collection, and the tags passed to apiary_managed_schema both contain the same tag name, the tag value passed to the apiary_managed_schema will be used. | map | null | no |
