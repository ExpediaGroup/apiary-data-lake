    ...
    template {
      metadata {
        ...
        annotations = {
          ...
          "ad.datadoghq.com/hms-readwrite.instances":"[{ \"prometheus_url\": \"http://%%host%%:8080/actuator/prometheus\", \"namespace\": \"hms-readwrite\", \"metrics\": [ ${var.metrics_init_total_count_tables_value}, ${var.metrics_init_total_count_dbs_value}, ${var.metrics_memory_heap_used_value}, ${var.metrics_init_total_count_partitions_value}, ${var.metrics_memory_heap_max_value}, ${var.metrics_threads_count_value}, ${var.metrics_classloading_loaded_value}], \"type_overrides\": { ${var.metrics_init_total_count_dbs_value}: \"gauge\", ${var.metrics_init_total_count_tables_value}: \"gauge\", ${var.metrics_memory_heap_used_value}: \"gauge\", ${var.metrics_init_total_count_partitions_value}: \"gauge\", ${var.metrics_memory_heap_max_value}: \"gauge\", ${var.metrics_threads_count_value}: \"gauge\", ${var.metrics_classloading_loaded_value}: \"gauge\" }, \"send_histograms_buckets\": true, \"send_monotonic_counter\": true, \"send_distribution_buckets\": true, \"send_distribution_counts_as_monotonic\": true }]"
