...
locals{
  hms_readwrite_template = templatefile("${path.module}/templates/apiary-hms-readwrite.json", {
    ...
    hms_metrics                = local.hms_metrics_readwrite
    hms_metrics_type_overrides = local.hms_metrics_type_overrides_readwrite
  ...
  hms_readonly_template = templatefile("${path.module}/templates/apiary-hms-readonly.json", {
    ...
    hms_metrics                = local.hms_metrics_readonly
    hms_metrics_type_overrides = local.hms_metrics_type_overrides_readonly
