...
variable "datadog_metrics_hms_readwrite_readonly" {
  ...
  type = list(
    object({
      name   = string # the original metric name from the Hive Metastore
      rename = optional(string) # the renamed metric
      type   = optional(string) # the type override
    })
  )
  default = [
    { name = "java_lang_garbagecollector_lastgcinfo_duration" },
    { name = "java_lang_memory_heapmemoryusage_max" },
    ...
    { name = "metrics_api_add_partition_50thpercentile" },
    { name = "metrics_api_add_partition_95thpercentile" },
    { name = "metrics_api_add_partition_999thpercentile" },
    { name = "metrics_api_add_partition_count" },
    { name = "metrics_api_add_partitions_50thpercentile" },
    { name = "metrics_api_add_partitions_95thpercentile" },
    { name = "metrics_api_add_partitions_999thpercentile" },
    { name = "metrics_api_add_partitions_count" },
    { name = "metrics_api_add_partitions_req_50thpercentile" },
    { name = "metrics_api_add_partitions_req_95thpercentile" },
    { name = "metrics_api_add_partitions_req_999thpercentile" },
    { name = "metrics_api_add_partitions_req_count" },
    { name = "metrics_api_alter_partitions_50thpercentile" },
    { name = "metrics_api_alter_partitions_95thpercentile" },
    { name = "metrics_api_alter_partitions_999thpercentile" },
    { name = "metrics_api_alter_partitions_count" },
    { name = "metrics_api_alter_partitions_with_environment_context_50thpercentile" },
    { name = "metrics_api_alter_partitions_with_environment_context_95thpercentile" },
    { name = "metrics_api_alter_partitions_with_environment_context_999thpercentile" },
    { name = "metrics_api_alter_partitions_with_environment_context_count" },
    { name = "metrics_api_alter_table_50thpercentile" },
    { name = "metrics_api_alter_table_95thpercentile" },
    { name = "metrics_api_alter_table_999thpercentile" },
    { name = "metrics_api_alter_table_count" },
    { name = "metrics_api_alter_table_with_cascade_count" },
    { name = "metrics_api_alter_table_with_environment_context_50thpercentile" },
    { name = "metrics_api_alter_table_with_environment_context_95thpercentile" },
    { name = "metrics_api_alter_table_with_environment_context_999thpercentile" },
    { name = "metrics_api_alter_table_with_environment_context_count" },
    { name = "metrics_api_create_function_count" },
    { name = "metrics_api_create_table_50thpercentile" },
    { name = "metrics_api_create_table_95thpercentile" },
    { name = "metrics_api_create_table_999thpercentile" },
    { name = "metrics_api_create_table_count" },
    { name = "metrics_api_create_table_with_environment_context_50thpercentile" },
    { name = "metrics_api_create_table_with_environment_context_95thpercentile" },
    { name = "metrics_api_create_table_with_environment_context_999thpercentile" },
    { name = "metrics_api_create_table_with_environment_context_count" },
    { name = "metrics_api_delete_column_statistics_by_table_count" },
    { name = "metrics_api_drop_partition_by_name_count" },
    { name = "metrics_api_drop_table_50thpercentile" },
    { name = "metrics_api_drop_table_95thpercentile" },
    { name = "metrics_api_drop_table_999thpercentile" },
    { name = "metrics_api_drop_table_count" },
    { name = "metrics_api_drop_table_with_environment_context_50thpercentile" },
    { name = "metrics_api_drop_table_with_environment_context_95thpercentile" },
    { name = "metrics_api_drop_table_with_environment_context_999thpercentile" },
    { name = "metrics_api_drop_table_with_environment_context_count" },
    { name = "metrics_api_flushcache_count" },
    { name = "metrics_api_get_all_databases_count" },
    { name = "metrics_api_get_all_functions_count" },
    { name = "metrics_api_get_all_tables_count" },
    { name = "metrics_api_get_config_value_count" },
    { name = "metrics_api_get_database_50thpercentile" },
    { name = "metrics_api_get_database_95thpercentile" },
    { name = "metrics_api_get_database_999thpercentile" },
    { name = "metrics_api_get_database_count" },
    { name = "metrics_api_get_databases_50thpercentile" },
    { name = "metrics_api_get_databases_95thpercentile" },
    { name = "metrics_api_get_databases_999thpercentile" },
    { name = "metrics_api_get_databases_count" },
    { name = "metrics_api_get_databases_max" },
    { name = "metrics_api_get_function_count" },
    { name = "metrics_api_get_functions_count" },
    { name = "metrics_api_get_indexes_count" },
    { name = "metrics_api_get_multi_table_count" },
    { name = "metrics_api_get_partition_by_name_count" },
    { name = "metrics_api_get_partition_count" },
    { name = "metrics_api_get_partition_names_count" },
    { name = "metrics_api_get_partitions_50thpercentile" },
    { name = "metrics_api_get_partitions_95thpercentile" },
    { name = "metrics_api_get_partitions_999thpercentile" },
    { name = "metrics_api_get_partitions_by_expr_count" },
    { name = "metrics_api_get_partitions_by_filter_50thpercentile" },
    { name = "metrics_api_get_partitions_by_filter_95thpercentile" },
    { name = "metrics_api_get_partitions_by_filter_999thpercentile" },
    { name = "metrics_api_get_partitions_by_filter_count" },
    { name = "metrics_api_get_partitions_by_names_count" },
    { name = "metrics_api_get_partitions_count" },
    { name = "metrics_api_get_partitions_max" },
    { name = "metrics_api_get_table_count" },
    { name = "metrics_api_get_table_meta_count" },
    { name = "metrics_api_get_table_metas_count" },
    { name = "metrics_api_get_table_objects_by_name_req_max" },
    { name = "metrics_api_get_table_req_50thpercentile" },
    { name = "metrics_api_get_table_req_95thpercentile" },
    { name = "metrics_api_get_table_req_999thpercentile" },
    { name = "metrics_api_get_table_req_count" },
    { name = "metrics_api_get_table_req_max" },
    { name = "metrics_api_get_tables_count" },
    { name = "metrics_api_getmetaconf_count" },
    { name = "metrics_api_lock_90thpercentile" },
    { name = "metrics_api_lock_95thpercentile" },
    { name = "metrics_api_lock_999thpercentile" },
    { name = "metrics_api_lock_count" },
    { name = "metrics_api_set_ugi_count" },
    { name = "metrics_api_shutdown_count" },
    { name = "metrics_api_unlock_50thpercentile" },
    { name = "metrics_api_unlock_95thpercentile" },
    { name = "metrics_api_unlock_999thpercentile" },
    { name = "metrics_api_unlock_count" },
    { name = "metrics_classloading_loaded_value" },
    { name = "metrics_init_total_count_dbs_value" },
    { name = "metrics_init_total_count_partitions_value" },
    { name = "metrics_init_total_count_tables_value" },
    { name = "metrics_jvm_pause_extrasleeptime_count" },
    { name = "metrics_jvm_pause_warn_threshold_count" },
    { name = "metrics_kafka_listener_failures_count" },
    { name = "metrics_kafka_listener_successes_count" },
    { name = "metrics_memory_heap_init_value" },
    { name = "metrics_memory_heap_max_value" },
    { name = "metrics_memory_heap_used_value" },
    { name = "metrics_memory_non_heap_max_value" },
    { name = "metrics_memory_non_heap_used_value" },
    { name = "metrics_open_connections_count" },
    { name = "metrics_threads_count_value" },
    { name = "metrics_threads_deadlock_count_value" },
    { name = "metrics_threads_runnable_count_value" },
    { name = "metrics_threads_waiting_count_value" },
