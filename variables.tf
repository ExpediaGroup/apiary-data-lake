...
variable "datadog_metrics_hms_readwrite_readonly" {
  ...
  default = [
    ...
    "jvm_memory_bytes_init",
    "jvm_memory_bytes_used",
    "metrics_api_get_table_meta_99thpercentile",
    "metrics_api_get_table_statistics_req_999thpercentile",
    "metrics_api_alter_partition_oneminuterate",
    "metrics_api_get_primary_keys_75thpercentile",
    "metrics_api_get_partition_names_ps_mean",
    "metrics_api_get_table_req_98thpercentile",
    "metrics_api_delete_column_statistics_by_table_99thpercentile",
    "metrics_api_drop_partitions_req_stddev",
    "metrics_api_get_table_req_count",
    "metrics_api_create_table_99thpercentile",
    "metrics_api_get_function_stddev",
    "metrics_api_drop_partition_by_name_99thpercentile",
    "metrics_memory_total_committed_value",
    "metrics_jvm_pause_extrasleeptime_count",
    "metrics_api_get_partitions_by_filter_count",
    "metrics_api_get_partition_by_name_99thpercentile",
    "metrics_api_get_role_grants_for_principal_min",
    "metrics_api_drop_table_99thpercentile",
    "metrics_api_alter_partitions_75thpercentile",
    "metrics_api_get_databases_count",
    "metrics_api_get_partitions_with_auth_95thpercentile",
    "metrics_api_get_all_tables_min",
    "metrics_api_get_all_functions_98thpercentile",
    "metrics_api_get_indexes_stddev",
    "metrics_api_get_aggr_stats_for_count",
    "metrics_api_update_table_column_statistics_count",
    "metrics_api_get_partition_99thpercentile",
    "metrics_api_get_partitions_statistics_req_min",
    "metrics_api_get_primary_keys_999thpercentile",
    "metrics_api_create_function_meanrate",
    "metrics_api_get_privilege_set_fiveminuterate",
    "metrics_api_alter_partitions_50thpercentile",
    "metrics_api_alter_table_with_cascade_mean",
    "metrics_api_get_table_objects_by_name_meanrate",
    "metrics_api_get_indexes_max",
    "metrics_api_drop_table_min",
    "metrics_api_get_databases_fifteenminuterate",
    "metrics_api_get_all_databases_75thpercentile",
    "metrics_api_add_partitions_req_98thpercentile",
    "metrics_api_get_partitions_names_ps_count",
    "metrics_api_alter_table_with_cascade_99thpercentile",
    "metrics_api_get_database_count",
    "metrics_delete_total_count_partitions_count",
    "metrics_api_update_table_column_statistics_75thpercentile",
    "metrics_api_grant_revoke_privileges_meanrate",
    "metrics_api_get_all_functions_count",
    "metrics_api_get_table_metas_count",
    "metrics_api_get_table_meanrate",
    "metrics_threads_waiting_count_value"
  ]
}
